...
if (array_key_exists('delete', $_GET) && validID($_POST['project_id'])) {
    // delete the set
...
<div class='toolbar'>
    ...
    <?php if ($project_info['status'] == 'active') { 
        echo "<span class='warning'>Saving an active project will make it inactive</span>"; 
    } ?>
</div>
